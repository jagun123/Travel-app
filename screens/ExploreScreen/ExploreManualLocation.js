...
const EnterManualLocation = ( props) => {
  // get the current user data from the firebase
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
          ...
          {searchResults.map(result => (
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                navigation.navigate('ExploreHomeScreen', { location: result ,});
              }}
            >
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ExploreHomeScreen', { 
